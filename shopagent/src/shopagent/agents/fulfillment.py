...
class FulfillmentAgent(Agent):
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "3. For each order with status 'cj_placed' or 'shipped': call "
            "check_cj_order; when a tracking number appears record it and set status "
            "'shipped'; when delivered set status 'delivered'.\n"
